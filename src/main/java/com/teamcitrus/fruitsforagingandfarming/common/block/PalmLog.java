            ...
            for (int y = 0; y <= 7; y++) {
                ...
                for (int x = -4; x <= 4; x++) {
                    ...
                    for (int z = -4; z <= 4; z++) {
                        ...
                        if (world.getBlockState(newpos).getBlock()== BlockRegistration.COCONUT && world.getBlockState(newpos.up()).getBlock()==BlockRegistration.PALM_LEAVES && BlockRegistration.COCONUT.getMetaFromState(world.getBlockState(newpos))>=2) {
